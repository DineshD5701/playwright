...
export const handleLoginPopUp = "//li[@value='Tea']";
export const handleLoginPopUpLunchOption = '//li[@value="Lunch"]';
export const hanleLoginPopUpRefresherOption = '//li[@value="Refresher"]';
export const hanleLoginPopUpBriefingOption = '//li[@value="Briefing"]';
export const hanleLoginPopUpTrainingOption = '//li[@value="Training"]';
